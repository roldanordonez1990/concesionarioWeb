...
public class DownloadImagenConcesionario extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Para devolver una imagen de un concesionario necesitamos conocer el id del mismo. Este Servlet se podría hacer de manera mucho
		...
		if (request.getParameter("idConcesionario") != null) { // comparar con "null" es la forma de comprobar si el parámetro está en la petición web
			String strIdConcesionaro = request.getParameter("idConcesionario");
			try {
				concesionario = (Concesionario) ConcesionarioControlador.getControlador().find(Integer.parseInt(strIdConcesionaro));
				...
				System.out.println("Profesor no encontrado para el id: " + strIdConcesionaro);
			}
